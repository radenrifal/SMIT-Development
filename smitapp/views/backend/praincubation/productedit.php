...
<div class="row clearfix">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="header">
                <a href="<?php echo base_url('prainkubasi/produk'); ?>" class="btn btn-sm btn-default waves-effect back pull-right">
                    <i class="material-icons">arrow_back</i> Kembali
                </a>
                <h2>Ubah Produk</h2>   
            </div>
            <div class="body">
                <?php echo form_open_multipart( 'praincubation/productpraedit', array( 'id'=>'productedit', 'role'=>'form' ) ); ?>
                <div id="alert" class="alert display-hide"></div>
                <div class="form-group form-float">
                    <section id="">
                        <h4>Masukan Data Produk Pra-Inkubasi yang Akan Dirubah</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="reg_event" id="reg_event" class="form-control" value="<?php echo strtoupper($productdata->event_title); ?>"  required disabled="TRUE">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary waves-effect" id="btn_productedit">Ubah Produk</button>
                        <button type="button" class="btn btn-danger waves-effect" id="btn_productedit_reset">Bersihkan</button>
                    </section>
                </div>
                <?php echo form_close(); ?>
            </div>
...
<div class="modal fade" id="save_productedit" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary waves-effect" id="do_save_productedit" data-dismiss="modal">Lanjut</button>
			</div>
		</div>
	</div>
</div>
